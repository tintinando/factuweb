...
const SUCCESS_XML = `<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
    <soapenv:Body>
        ...
        <header>
            ...
            <expirationTime>2026-07-27T12:12:34.261-03:00</expirationTime>
        </header>
        <credentials>
            <token>myBeautifulToken</token>
            <sign>myAwfulSign</sign>
        </credentials>
        </loginTicketResponse>]]>
        </loginCmsReturn>
        </loginCmsResponse>
